...
public class AlbertController {
	...
	public ResponseEntity<ResultBean> getWatchByAlbert(@PathVariable Integer id) {
		ResultBean resultBean = null;
		try {
			resultBean = new ResultBean(watchService.findByAlbertType(albertTypeService.findById(id).get()),
	...
	public ResponseEntity<ResultBean> addAlbert(@RequestBody String json) {
		ResultBean resultBean = null;
		try {
			albertTypeService.save(new AlbertType(null, new JSONObject(json).getString("name"), null));
	...
	public ResponseEntity<ResultBean> updateAlbert(@PathVariable Integer id, @RequestBody String json) {
		ResultBean resultBean = null;
		try {
			albertTypeService.save(new AlbertType(id, new JSONObject(json).getString("name"), null));
